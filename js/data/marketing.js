...
const marketingSizingNote = "يتم تنفيذ التصميم بالمقاسات القياسية المتعارف عليها للمنصة المطلوبة، وإذا كان لديك مقاسات أو أبعاد خاصة، يرجى كتابتها بوضوح في حقل الملاحظات عند الطلب.";
